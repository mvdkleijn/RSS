<h1><img src="<?php echo URL_PUBLIC; ?>/frog/plugins/rss/images/home.png" align="center" /> RSS Feeds</h1>
...
<td><p><strong style="font-weight: bold; font-size: 26px;"><?php echo $name; ?></strong><br />
<a href="<?php echo $url; ?>"><?php echo $url ; ?></a></p></td>
...
<td style="text-align: right;"><a href="<?php echo get_url('plugin/rss/remove/'.$id); ?>" onclick="return confirm('Delete the <?php echo $name ?> feed?');"><img src="../frog/plugins/rss/images/delete.png" alt="remove icon" /></a>
<a href="<?php echo get_url('plugin/rss/edit/'.$id.''); ?>"><img src="../frog/plugins/rss/images/edit.png" alt="edit icon" /></a>
</td>
</tr><?php
		}
	}
